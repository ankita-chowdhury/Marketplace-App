...
const DetailsModal = ({
  ...
  const submitBuyItem = () => {
    axios
      .patch(`${BASE_URL}/products/${item.id}`, {
        soldFlag: true,
      })
      .then((res) => {
        ...
        const date = new Date();
        const fomattedDate = `${String(date.getDate()).padStart(
          2,
          "0"
        ...
        setActionMsg("Product Purchased Successfully!");
        setTimeout(() => {
          setActionMsg("");
        }, 3000);
        setShowDetailsModal(false);
    ...
    <div className="modal" tabIndex="-1" role="dialog">
      <div className="modal-box-container" role="document">
        <div className="modal-heading">
          ...
          <span onClick={() => closeDetailsModal()}>
            {" "}
        ...
        <div className="modal-body">
          ...
          {!showDetailsState && (
            <div className="add-item-form-btn">
              <button className="add-btn-save" onClick={() => submitBuyItem()}>
                Buy
              </button>
              <button
